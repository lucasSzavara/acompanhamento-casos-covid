...
for uf in df_cidade['state'].unique():
    ...
    fig.add_trace(go.Scatter(
        ...
        y=df_uf['last_available_death_rate'] * 100,
        name=uf
    ))
...
evolucao_mortalidade = html.Div(get_cards(
    html.Div(
        [
            html.Div(dcc.Graph(id='grafico_evolucao_cidade', figure=fig))
        ],
        id='evolucao_mortalidade_por_estado'
    ), header='Comparativo de mortalidade por dia'
), className='col-6')
